...
<html lang="en">
   ...
   <body>
      ...
      <p>You are connected to the Project 4 Enterprise System database as a <span class="label">client-level</span> user.</p>
      <p>Please enter any valid SQL query or update command in the box below.</p>
      
      <div class = "line"> </div>
      
      <div class = "form">
	      <form action = "/Project4/clientSQLCommands" method = "post">
