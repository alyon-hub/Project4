...
public class clientSQLCommands extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) {
        ...
        RequestDispatcher view = session.getServletContext().getRequestDispatcher("/clientHome.jsp");
    ...
    //updateQuery isn't exactly necessary here since client cannot use update, but it was easier to include everything since the error will be hit anyways
